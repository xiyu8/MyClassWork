package com.example.maplibstest;
...
import com.example.maplibstest.overlayutil.BikingRouteOverlay;
import com.example.maplibstest.overlayutil.DrivingRouteOverlay;
import com.example.maplibstest.overlayutil.MassTransitRouteOverlay;
import com.example.maplibstest.overlayutil.OverlayManager;
import com.example.maplibstest.overlayutil.RouteLineAdapter;
import com.example.maplibstest.overlayutil.TransitRouteOverlay;
import com.example.maplibstest.overlayutil.WalkingRouteOverlay;

import java.util.List;

public class PlanRouteActivity extends AppCompatActivity implements BaiduMap.OnMapClickListener,
     ...
     */
        ...
        public void nodeClick(View v) {
            ...
            // show popup
            popupText = new TextView(PlanRouteActivity.this);
        ...
        public void onGetWalkingRouteResult(WalkingRouteResult result) {
            if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
                Toast.makeText(PlanRouteActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
            }
            ...
            if (result.error == SearchResult.ERRORNO.NO_ERROR) {
                ...
                if (result.getRouteLines().size() > 1 ) {
                    ...
                    MyTransitDlg myTransitDlg = new MyTransitDlg(PlanRouteActivity.this,
